...
Formats patient event timelines from MEDS format into structured text
suitable for model inference. Provides utilities for extracting and
formatting demographics, conditions, measurements, observations,
procedures, drugs, and imaging paths.
